    ...
    actions: {
        ...
        importAlatKontruksi(_, file) {
            return new Promise((resolve, reject) => {
                ...
                axios.post('/alat_kontruksi/import', formData, config).then(resp => {
                    resolve(resp)
                }).catch(e => {
                    reject(e)
                })
        ...
        selectedAction(_, {action, data}) {
            return new Promise((resolve, reject) => {
                axios.post('/alat_kontruksi/selected_action/' + action, { data: data }).then(resp => {
        ...
        exportReport(_, _params) {
            return new Promise((resolve, reject) => {
                axios.get('/alat_kontruksi/selected_action/export_excel',  { params: _params, responseType: 'blob' }).then(resp => {
                    resolve(resp);
                }).catch(e => {
                    reject(e)
                })
        ...
        ReportByDate(_, _params) {
            return new Promise((resolve, reject) => {
                axios.get('/alat_kontruksi/selected_action/export_pdf', { params: _params }).then(resp => {
                    resolve(resp);
                }).catch(e => {
                    reject(e)
                })
