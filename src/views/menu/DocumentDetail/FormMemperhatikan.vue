<template>
    <div class="container">
        ...
        <button @click="add" class="btn btn-sm btn-success mt-3"><CIcon name="cilMedicalCross" /> Tambah Memperhatikan</button>
    </div>
</template>
        ...
        watch: {
            $v: {
                handler: function (val) {
                    if(!val.$invalid && this.document_notices.length > 0) {
