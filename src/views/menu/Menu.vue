...
<script>
import * as data from "../../model/menu";
...
export default {
  ...
  methods: {
    ...
    getKecamatan() {
      this.$store
        .dispatch("menu/getKecamatan", this.params)
        .then((resp) => {
    ...
    importData() {
      var loading = this.$loading.show();
      this.$store
        .dispatch("menu/import", this.file)
        .then((res) => {
